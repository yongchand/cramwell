...
export default function ResetPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background dark:bg-gray-950 transition-colors">
      <form
        onSubmit={handleReset}
        className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-8 rounded-xl shadow-lg w-full max-w-md border border-gray-200 dark:border-gray-800"
      >
